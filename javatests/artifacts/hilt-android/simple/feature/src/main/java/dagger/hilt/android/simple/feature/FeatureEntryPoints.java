...
public final class FeatureEntryPoints {
  ...
  public static void invokeEntryPoints(Context context) {
    EntryPointAccessors.fromApplication(context, DeepAndroidLib.LibEntryPoint.class)
        .getDeepAndroidInstance();

    EntryPointAccessors.fromApplication(context, DeepLib.LibEntryPoint.class).getDeepInstance();
  }
